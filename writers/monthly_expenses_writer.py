...
def create_monthly_expenses_worksheets(workbook: Workbook, finance_data: FinanceData):
    ...
    for year in finance_data.get_years():
        ...
        create_monthly_expenses_worksheet(workbook, f'{year}_EXPENSES', monthly_expenses, monthly_percent_change)
...
def create_monthly_expenses_worksheet(workbook: Workbook,
    ...
    create_expenses_section(workbook, worksheet, worksheet_name, monthly_expenses, months, expenses_category_row_index,
                            ...
                            expenses_data_start_col_index)

    create_percent_change_section(workbook, worksheet, worksheet_name, monthly_percent_change, months, pc_category_row_index,
                                  pc_category_col_start_index, num_categories, pc_month_col_index,
                                  pc_month_row_start_index, num_months, pc_data_start_row_index,
                                  pc_data_start_col_index)
...
def create_expenses_section(workbook: Workbook,
    ...
    totals_row_index = num_months + 1
    worksheet.write(totals_row_index, month_col_index, 'Total')
    writer_utils.write_sum_row(worksheet, totals_row_index, data_start_row_index, num_months, data_start_col_index,
                               num_categories)
    ...
    writer_utils.create_line_chart_with_series_as_cols(credit_card_data_chart, worksheet_name, category_row_index,
                                                       month_col_index, data_start_row_index, num_months,
